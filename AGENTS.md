...
5. **f00 aesthetic** on the public site: Heartbox palette (default f00 theme) via https://f00.sh/theme/f00-theme-13.css — Onyx brand, zine body, chip chrome (dense tables OK; no phosphor green).
